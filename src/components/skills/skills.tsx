...
const SkillsSection = () => (
  <section className="py-8 px-4 bg-gray-100 rounded opacity-90">
    <div className="container mx-auto text-center">
      <h2 className="text-3xl font-semibold text-gray-800">Skills</h2>
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 justify-content-around gap-6 mt-8">
